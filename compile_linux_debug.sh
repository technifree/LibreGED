#!/bin/bash
# Build de débogage — sans --windowed pour voir les erreurs dans le terminal
# Usage : ./compile_linux_debug.sh
# NE PAS distribuer ce binaire (GLIBC LMDE 7, incompatible avec les vieilles distros)
